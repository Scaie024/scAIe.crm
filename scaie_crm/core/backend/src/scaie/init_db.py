...
def init_db():
    ...
    try:
        # Asegurar que el motor esté conectado
        engine.connect()
        ...
        required_tables = ['contacts', 'conversations', 'messages', 'agent_actions', 'agent_tasks']
        
        missing_tables = [table for table in required_tables if table not in existing_tables]
        if missing_tables:
            print(f"Advertencia: Faltan tablas después de la inicialización: {missing_tables}")
