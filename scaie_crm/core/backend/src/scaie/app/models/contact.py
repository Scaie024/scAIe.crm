    ...
    def to_dict(self):
        ...
        try:
            return {
                ...
                "notes": self.notes,
                "interest_level": self.interest_level.value if isinstance(self.interest_level, enum.Enum) else self.interest_level,
                ...
                "platform": self.platform.value if isinstance(self.platform, enum.Enum) else self.platform,
                "created_at": self.created_at.isoformat() if self.created_at else None,
                "updated_at": self.updated_at.isoformat() if self.updated_at else None,
            }
        except Exception as e:
            logger.error(f"Error converting contact to dict: {str(e)}")
            raise
